...
class Meeting_Room(models.Model):
    ...
    equipments = models.ManyToManyField(Meeting_Equipment, 
        related_name='room_equipments', through='Meeting_Room_Equipment')
    objects = models.Manager()
...
class Meeting_Room_Equipment(models.Model):
    ...
    equipment = models.ForeignKey(Meeting_Equipment, 
        related_name="room_equipment_equipment", on_delete=models.CASCADE, null=True)
...
class Meeting_Request(models.Model):
    ...
    meeting_member_no = models.PositiveSmallIntegerField(null=True)
    ...
    equipments = models.ManyToManyField(Meeting_Equipment, 
        related_name='request_equipments', through='Meeting_Request_Equipment')
    objects = models.Manager()  
...
class Meeting_Request_Equipment(models.Model):
    request = models.ForeignKey(Meeting_Request, 
        related_name="request_equipment_request", on_delete=models.CASCADE, null=True)
    equipment = models.ForeignKey(Meeting_Equipment, 
        related_name="request_equipment_equipment", on_delete=models.CASCADE, null=True)
    qty = models.PositiveSmallIntegerField(null=True)
    description = models.CharField(max_length=500, null=True)
    objects = models.Manager()  
...
class Meeting_Request_Cater_Type(models.Model):
    request = models.ForeignKey(Meeting_Request, 
        related_name='request_cater_type_request', on_delete=models.CASCADE, null=True)        
    cater_type = models.ForeignKey(Meeting_Cater_Type, 
        related_name='request_cater_type_cater_type', on_delete=models.CASCADE, null=True)
    description = models.CharField(max_length=500, null=True)
    objects = models.Manager()  
